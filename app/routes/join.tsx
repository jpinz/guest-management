...
export async function action({ request }: ActionArgs) {
  ...
  const authSession = await createUserAccount(email, password, name, gradYear, rushClass, organizationId, Role.UNVERIFIED, false);
      ...
      <div className="mx-auto w-full max-w-md px-8">
        <Form ref={zo.ref} method="post" className="space-y-6" replace>
          ...
          <button
            ...
            type="submit"
            className="w-full rounded bg-blue-500  px-4 py-2 text-white focus:bg-blue-400 hover:bg-blue-600"
            disabled={disabled}
          >
            {t("register.action")}
          </button>
